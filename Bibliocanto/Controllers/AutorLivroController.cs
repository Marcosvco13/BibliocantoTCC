...
namespace Bibliocanto.Controllers
{
    ...
    public class AutorLivroController : ControllerBase
    {
        ...
        [HttpGet("livro/{idLivro:int}", Name = "GetByIdLivroAutor")]
        public async Task<ActionResult<IEnumerable<AutorLivroResource>>> GetAutorByIdLivro(int idLivro)
        {
        ...
        [HttpGet("autor/{idAutor:int}", Name = "GetByIdAutor")]
        ...
        public async Task<IActionResult> PostAsync([FromBody] SaveAutoresLivrosResource resource)
        {
            if (!ModelState.IsValid)
                return BadRequest(ModelState.GetErrorMessages());

            var autorlivro = _mapper.Map<SaveAutoresLivrosResource, AutoresLivros>(resource);
